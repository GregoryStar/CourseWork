 ...
 ******************************************************************************/
 /**
 * @brief When robot touches the home base you win.
 */
class HomeBase: public ArenaMobileEntity {
 ...
 public:
   ...
   * rather than use RobotMotionHandler. The nicest solution would
   * probably be to make a general motion handler class and have robot
