...
#ifndef PROJECT_ITERATION3_SRC_GRAPHICS_ARENA_VIEWER_H_
#define PROJECT_ITERATION3_SRC_GRAPHICS_ARENA_VIEWER_H_
...
class GraphicsArenaViewer : public GraphicsApp {
 public:
  ...
  /**
   * @brief Draw the arena with all players, obstacles using nanogui.
   *
...
#endif  // PROJECT_ITERATION3_SRC_GRAPHICS_ARENA_VIEWER_H_
