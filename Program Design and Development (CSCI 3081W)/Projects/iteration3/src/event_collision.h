...
#ifndef PROJECT_ITERATION3_SRC_EVENT_COLLISION_H_
#define PROJECT_ITERATION3_SRC_EVENT_COLLISION_H_
 ...
 ******************************************************************************/
 /**
  * @brief An event that hold information for a collision.
  */
...
#endif /* PROJECT_ITERATION3_SRC_EVENT_COLLISION_H_ */
