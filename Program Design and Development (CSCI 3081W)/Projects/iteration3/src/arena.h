...
#ifndef PROJECT_ITERATION3_SRC_ARENA_H_
#define PROJECT_ITERATION3_SRC_ARENA_H_
...
class Arena {
 public:
  ...
  /**
   * @brief Return whether is game is won or not.
   */
  bool gameWon() {
    return gameWon_;
  }
  ...
  /**
   * @brief Return whether is game is lost or not.
   */
  bool gameLost() {
    return gameLost_;
  }
  ...
  */
  ...
  /**
  * @brief Reset everything inside of Arena.
  */
  void Reset(void);
 ...
 private:
  ...
  // State variables related to ending the game
  bool gameWon_;
  bool gameLost_;
...
#endif  // PROJECT_ITERATION3_SRC_ARENA_H_
