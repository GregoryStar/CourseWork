...
#ifndef PROJECT_ITERATION3_SRC_ARENA_MOBILE_ENTITY_PARAMS_H_
#define PROJECT_ITERATION3_SRC_ARENA_MOBILE_ENTITY_PARAMS_H_
...
#endif /* PROJECT_ITERATION3_SRC_ARENA_MOBILE_ENTITY_PARAMS_H_ */
